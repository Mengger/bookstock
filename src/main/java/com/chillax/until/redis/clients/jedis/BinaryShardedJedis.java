...
import com.chillax.until.redis.clients.util.Hashing;
import com.chillax.until.redis.clients.util.Sharded;
...
public class BinaryShardedJedis extends Sharded<Jedis, JedisShardInfo>
	...
	if(log.isDebugEnabled())
		log.error("本次调用随机获取的连接地址为："+j.getClient().getHost()+":"+j.getClient().getPort());
	return j.get(key);
    }
